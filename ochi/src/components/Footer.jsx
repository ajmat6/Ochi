...
const Footer = () => {
  return (
    <div className='rounded-t-2xl border-t-2 h-[101vh]'>
        <div className='flex text-zinc-50 py-24  mx-16'>
            <div className='flex flex-col justify-between w-[50%]  uppercase text-[100px] font-["Test Founders Grotesk"] leading-[5.8vw] tracking-tighter font-medium'>
                ...
                <a className='logo' href='http://ochi.design'>
            ...
            <div className=''>
                <div className='w-[50%] mr-16 uppercase text-8xl font-["Test Founders Grotesk"] leading-[5.8vw] tracking-tighter font-medium'>Presentations</div>
                <div className='mt-12'>
                    <div>S:</div>
                ...
                <div className='flex justify-between'>
                    ...
                    <div className='mt-8 mr-10'>
                        <div>M:</div>
                        <div className='flex flex-col mt-3'>
                            <a className='underline' href="https://www.instagram.com/ochi_design/">Home</a>
                            <a href="https://www.behance.net/ochi_design">Services</a>
                            <a href="https://www.facebook.com/profile.php?id=100067218942460">Our Work</a>
                            <a href="https://www.linkedin.com/company/ochi-design/">About us</a>
                            <a href="https://www.linkedin.com/company/ochi-design/">Insigts </a>
                            <a href="https://www.linkedin.com/company/ochi-design/">Contact us</a>
                        </div>
                    </div>
                </div>
                <div className='mt-6'>
                    <div>E:</div>
                    <div className='flex flex-col mt-3'>
                        <a className='underline' href="https://www.instagram.com/ochi_design/">hello@ochi.design</a>
                    </div>
                </div>
                <div className='flex justify-between mt-14 text-[#B2B2B2] text-[1.1rem]'>
                    <div className='flex gap-1'>
                        <div>&copy; Ochi design 2024.</div>
                        <a href="">Legal Terms</a>
                    </div>
                    <div className='cursor-pointer'>Website by obys</div>
                </div>
            </div>
        </div>
    </div>
